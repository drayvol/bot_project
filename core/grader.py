"""Grader — точка входа ядра: оценка фото решения задания №13.
...
Ключи окружения: GOOGLE_API_KEY , WOLFRAM_API_KEY .
"""
...
from core.checker_v2 import check_solution_recovered
from core.normalize import normalize_latex, normalize_steps
from core.pipeline import ocr_image, build_checker_report, formal_verification
from core.verdict import extract_score_from_verification
...
class Grader:
    ...
    def similar_tasks(self, equation_latex: str, top_k: int = 3) -> list:
        ...
        from core.search_equations import search
