"""Поиск похожих уравнений по косинусной близости (Qdrant).

Использование:
  python -m core.search_equations '2\\cos^2 x + 3\\sin x - 3 = 0' --top 10
...
from core.build_equation_index import normalize_equation, QDRANT_PATH, COLLECTION, VECTORIZER_PATH
